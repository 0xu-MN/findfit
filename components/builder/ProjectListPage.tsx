...
import { listDrafts, listSubmitted } from './new-request/storage'
...
export default function ProjectListPage() {
  ...
  const inProgressCount = submitted.length
              ...
              >
                ...
                <div className="flex flex-col gap-1.5">
                  <div className="flex items-center justify-between text-[9px] font-bold text-[#666]">
                    <span>응답 수집률</span>
                    <span className="text-[#F77019]">0 / {s.evaluatorCount}</span>
                  </div>
                  <div className="w-full h-1.5 bg-[#EEEEEE] rounded-full overflow-hidden">
                    <div className="h-full bg-[#F77019]" style={{ width: '0%' }} />
                  </div>
                </div>
