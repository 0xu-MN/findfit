...
const steps = [
  ...
  { n: '02', title: '리뷰어 매칭', desc: 'FindFit이 조건에 맞는 리뷰어를 자동으로 연결하고 기밀유지 동의를 처리해요', tag: '타겟 기반 필터링 적용' },
  { n: '03', title: '피드백 수집', desc: '리뷰어들이 상세 평가와 의견을 작성해요. 진행 상황을 실시간으로 확인할 수 있어요', tag: '동의 절차를 거쳐 진행돼요' },
